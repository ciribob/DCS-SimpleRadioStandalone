		...
		local _status,_result = pcall(function()
			...
			if _data ~= nil then
				...
				_update = {
					...
					unitId = 0,
					ptt = false,
					radios = { -- Radio 1 is always Intercom
				...
				_update = {
					...
					radios = { -- Radio 0 is always intercom now -- disabled if AWACS panel isnt open
...
function SR.exportRadioC101CC(_data)
	...
	-- TODO figure out which cockpit you're in? So we can have controls working in the rear?
...
SR.log("Loaded SimpleRadio Standalone Export version:1.5.9.0")
