...
namespace Ciribob.DCS.SimpleRadio.Standalone.Client.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Auto connect on startup (last server).
        /// </summary>
        public static string StartupAutoConnect {
            get {
                return ResourceManager.GetString("StartupAutoConnect", resourceCulture);
            }
        }

        /// <summary>
        ///   Looks up a localized string similar to Auto enable radio overlay on startup.
        /// </summary>
        public static string StartupAutoEnableOverlay {
            get {
                return ResourceManager.GetString("StartupAutoEnableOverlay", resourceCulture);
            }
        }
