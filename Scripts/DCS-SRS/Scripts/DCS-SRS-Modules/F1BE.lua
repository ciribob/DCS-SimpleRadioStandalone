function exportRadioF1BE(_data, SR)
    ...
    _data.iff.mode1 = tonumber(SR.getNonStandardSpinner(732, _lookupTable, 0.125, 3) .. SR.getNonStandardSpinner(733, {
        [0.000] = "0",
        [0.125] = "1",
        [0.250] = "2",
        [0.375] = "3",
    ...
    if SR.lastKnownSeat == 0 then
        ...
        if SR.getSelectorPosition(300, 0.5) == 1 then
            _data.radios[2].channel = SR.getNonStandardSpinner(303, {
                [0.000] = "1",
                [0.050] = "2",
                [0.100] = "3",
                [0.150] = "4",
