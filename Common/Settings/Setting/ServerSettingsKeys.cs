...
public enum ServerSettingsKeys
{
    ...
    ATCAWACS_EXPORT_ENABLED = 20,
    ATCAWACS_EXPORT_PORT = 21,
    ATCAWACS_EXPORT_IP = 22,
    UPNP_ENABLED = 23,
...
public class DefaultServerSettings
{
    public static readonly Dictionary<string, string> Defaults = new()
    {
        ...
        { ServerSettingsKeys.ATCAWACS_EXPORT_ENABLED.ToString(), "false" },
        { ServerSettingsKeys.ATCAWACS_EXPORT_PORT.ToString(), "10712" },
        { ServerSettingsKeys.ATCAWACS_EXPORT_IP.ToString(), "127.0.0.1" },
