...
log.write('SRS-OverlayGameGUI', log.INFO, "Loading - DCS-SRS Overlay GameGUI - Ciribob: 2.3.6.0 ")
...
function srsOverlay.updateRadio()    
    ...
    if _radioState and _radioState.RadioInfo and _radioState.RadioInfo.radios then
        ...
        -- IFF_STATUS:  OFF = 0,  NORMAL = 1 , or IDENT = 2 (IDENT means Blink on LotATC and DCS Airspace) , 3 DISABLED
...
log.write('SRS-OverlayGameGUI', log.INFO, "Loaded - DCS-SRS Overlay GameGUI - Ciribob: 2.3.6.0 ")
