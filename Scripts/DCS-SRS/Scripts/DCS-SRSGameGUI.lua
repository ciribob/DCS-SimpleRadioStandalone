...
log.write('SRS-GameGUI', log.INFO, "Loading - DCS-SRS GameGUI - Ciribob: 2.3.0.3")
...
SRS.handleRadio = function(msg)
    ...
    local keys = { "SELECT", "RADIO", "FREQ", "GUARD", "FREQUENCY", "GRD", "FRQ", "VOL", "VOLUME", "CHANNEL", "CHN" }
...
net.log("Loaded - DCS-SRS GameGUI - Ciribob: 2.3.0.3")